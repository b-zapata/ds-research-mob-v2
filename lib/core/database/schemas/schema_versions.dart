...
final class Schema10 extends i0.VersionedSchema {
  ...
  late final Shape21 focusSessionsTable = Shape21(
      ...
      alias: null);
  late final Shape27 mindfulSettingsTable = Shape27(
      source: i0.VersionedTable(
        entityName: 'mindful_settings_table',
        withoutRowId: false,
        isStrict: false,
  ...
  late final Shape24 notificationsTable = Shape24(
      ...
      alias: null);
  late final Shape28 sessionTable = Shape28(
      source: i0.VersionedTable(
        entityName: 'session_table',
        withoutRowId: false,
        isStrict: false,
        tableConstraints: [],
        columns: [
      ...
      alias: null);
  late final Shape29 studyConfigTable = Shape29(
      source: i0.VersionedTable(
        entityName: 'study_config_table',
        withoutRowId: false,
        isStrict: false,
        tableConstraints: [
          'PRIMARY KEY(id)',
      ...
      alias: null);
  late final Shape30 promptDeliveryLogTable = Shape30(
      source: i0.VersionedTable(
        entityName: 'prompt_delivery_log_table',
        withoutRowId: false,
        isStrict: false,
        tableConstraints: [],
        columns: [
...
class Shape27 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get appVersion =>
      columnsByName['app_version']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get interventionArm =>
      columnsByName['intervention_arm']! as i1.GeneratedColumn<int>;
}

i1.GeneratedColumn<int> _column_93(String aliasedName) =>
    i1.GeneratedColumn<int>('intervention_arm', aliasedName, false,
        type: i1.DriftSqlType.int, defaultValue: const Constant(3));
...
i1.GeneratedColumn<DateTime> _column_95(String aliasedName) =>
...
class Shape30 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get id =>
      columnsByName['id']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get sessionIdFk =>
      columnsByName['session_id_fk']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get templateIdFk =>
      columnsByName['template_id_fk']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get outcome =>
      columnsByName['outcome']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get responseContent =>
      columnsByName['response_content']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get triggerType =>
      columnsByName['trigger_type']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get appPackage =>
      columnsByName['app_package']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get secondsSpent =>
      columnsByName['seconds_spent']! as i1.GeneratedColumn<int>;
...
i1.GeneratedColumn<int> _column_98(String aliasedName) =>
    i1.GeneratedColumn<int>('session_id_fk', aliasedName, false,
        type: i1.DriftSqlType.int);
i1.GeneratedColumn<int> _column_99(String aliasedName) =>
    i1.GeneratedColumn<int>('template_id_fk', aliasedName, true,
        type: i1.DriftSqlType.int, defaultValue: const Constant(null));
i1.GeneratedColumn<String> _column_100(String aliasedName) =>
    i1.GeneratedColumn<String>('outcome', aliasedName, false,
        type: i1.DriftSqlType.string,
        defaultValue: const Constant("abandoned"));
i1.GeneratedColumn<String> _column_101(String aliasedName) =>
    i1.GeneratedColumn<String>('response_content', aliasedName, false,
        type: i1.DriftSqlType.string, defaultValue: const Constant(""));
i1.GeneratedColumn<String> _column_102(String aliasedName) =>
    i1.GeneratedColumn<String>('trigger_type', aliasedName, false,
        type: i1.DriftSqlType.string, defaultValue: const Constant("launch"));
i1.GeneratedColumn<String> _column_103(String aliasedName) =>
    i1.GeneratedColumn<String>('app_package', aliasedName, false,
        type: i1.DriftSqlType.string, defaultValue: const Constant(""));
i1.GeneratedColumn<int> _column_104(String aliasedName) =>
    i1.GeneratedColumn<int>('seconds_spent', aliasedName, false,
        type: i1.DriftSqlType.int, defaultValue: const Constant(0));
...
i1.GeneratedColumn<DateTime> _column_106(String aliasedName) =>
    i1.GeneratedColumn<DateTime>('completed_at', aliasedName, true,
        type: i1.DriftSqlType.dateTime, defaultValue: const Constant(null));
i1.GeneratedColumn<bool> _column_107(String aliasedName) =>
    i1.GeneratedColumn<bool>('success', aliasedName, false,
        type: i1.DriftSqlType.bool,
        defaultConstraints: i1.GeneratedColumn.constraintIsAlways(
...
final class Schema11 extends i0.VersionedSchema {
  ...
  late final Shape30 promptDeliveryLogTable = Shape30(
      ...
      alias: null);
  late final Shape31 promptTable = Shape31(
      source: i0.VersionedTable(
        entityName: 'prompt_table',
        withoutRowId: false,
        isStrict: false,
        tableConstraints: [
          'PRIMARY KEY(id)',
...
class Shape31 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get minLockSeconds =>
      columnsByName['min_lock_seconds']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get expectedInteraction =>
      columnsByName['expected_interaction']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<bool> get active =>
      columnsByName['active']! as i1.GeneratedColumn<bool>;
  i1.GeneratedColumn<DateTime> get updatedAt =>
      columnsByName['updated_at']! as i1.GeneratedColumn<DateTime>;
  i1.GeneratedColumn<String> get requiredPlaceholders =>
      columnsByName['required_placeholders']! as i1.GeneratedColumn<String>;
}
...
i1.GeneratedColumn<int> _column_110(String aliasedName) =>
    i1.GeneratedColumn<int>('group', aliasedName, false,
        type: i1.DriftSqlType.int);
...
i1.GeneratedColumn<String> _column_112(String aliasedName) =>
    i1.GeneratedColumn<String>('prompt_text', aliasedName, false,
        type: i1.DriftSqlType.string);
i1.GeneratedColumn<int> _column_113(String aliasedName) =>
    i1.GeneratedColumn<int>('min_lock_seconds', aliasedName, false,
        type: i1.DriftSqlType.int);
i1.GeneratedColumn<String> _column_114(String aliasedName) =>
    i1.GeneratedColumn<String>('expected_interaction', aliasedName, false,
        type: i1.DriftSqlType.string, defaultValue: const Constant('wait_out'));
i1.GeneratedColumn<bool> _column_115(String aliasedName) =>
    i1.GeneratedColumn<bool>('active', aliasedName, false,
        type: i1.DriftSqlType.bool,
        defaultConstraints:
            i1.GeneratedColumn.constraintIsAlways('CHECK ("active" IN (0, 1))'),
        defaultValue: const Constant(true));
i1.GeneratedColumn<String> _column_116(String aliasedName) =>
    i1.GeneratedColumn<String>('required_placeholders', aliasedName, false,
        type: i1.DriftSqlType.string, defaultValue: const Constant("[]"));
